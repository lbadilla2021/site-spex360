 ...
 * 
 * Este script lee los cursos desde LocalStorage (vía POST)
 * y genera archivos HTML estáticos en la carpeta /cursos/
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result !== false) {
        ...
        echo json_encode([
            ...
            'message' => 'Curso generado exitosamente'
        ]);
    } else {
        http_response_code(500);
